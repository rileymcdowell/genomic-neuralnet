...
def get_mlp_network_regressor(num_inputs, num_hidden, num_outputs):
    """
    ...
    """
    hidden_layer = SigmoidLayer(num_inputs, num_hidden)
    output_layer = LinearLayer(num_hidden, num_outputs)
    network = Network(hidden_layer, output_layer)
    return network

def get_mlp_network_classifier(num_inputs, num_hidden, num_outputs):
    """
